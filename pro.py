...
OWNER = 'Cyber Muslim Army'
git_hub = 'github.com/CMA-ARMY'
faceb0ok = 'TEAM CMA'
...
def tahunng(fx):
	if len(fx)==15:
		if fx[:10] in ['1000000000']       :CMA = '2009'
		elif fx[:9] in ['100000000']       :CMA = '2009'
		elif fx[:8] in ['10000000']        :CMA = '2009'
		elif fx[:7] in ['1000000','1000001','1000002','1000003','1000004','1000005']:CMA = '2009'
		elif fx[:7] in ['1000006','1000007','1000008','1000009']:CMA = '2010'
		elif fx[:6] in ['100001']          :CMA = '2010-2011'
		elif fx[:6] in ['100002','100003'] :CMA = '2011-2012'
		elif fx[:6] in ['100004']          :CMA = '2012-2013'
		elif fx[:6] in ['100005','100006'] :CMA = '2013-2014'
		elif fx[:6] in ['100007','100008'] :CMA = '2014-2015'
		elif fx[:6] in ['100009']          :CMA = '2015'
		elif fx[:5] in ['10001']           :CMA = '2015-2016'
		elif fx[:5] in ['10002']           :CMA = '2016-2017'
		elif fx[:5] in ['10003']           :CMA = '2018'
		elif fx[:5] in ['10004']           :CMA = '2019'
		elif fx[:5] in ['10005']           :CMA = '2020'
		elif fx[:5] in ['10006','10007','10008']:CMA = '2021-2022'
		else:CMA=''
	elif len(fx) in [9,10]:
		CMA = '2008-2009'
	elif len(fx)==8:
...
def login():
	...
	try:
		...
		link = ('https://t.me/cmahackerteam/?flite=scwspnss')
